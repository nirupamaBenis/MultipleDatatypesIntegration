#### This script contains functions essential to the working of cyrest

## The fucntion that prepares an igraph object to be sent to Cytoscape
...
## checks if the object has the neccessary attributes
...
## final function that send the network to Cytoscape
